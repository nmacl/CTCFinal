...
public class Grandpa extends Kit {
    ...
    public void shootGun() {
        if (ammo > 0) {
            ammo -= 1;
            p.playSound(p.getLocation(), Sound.ENTITY_FIREWORK_ROCKET_BLAST, 1f, 0.1f);
    ...
    public void drinkBooze() {
            ...
            new BukkitRunnable() { // Handles booze reload buff duration
                ...
                public void run() {
                    ...
                    new BukkitRunnable() { // Handles booze return cooldown
